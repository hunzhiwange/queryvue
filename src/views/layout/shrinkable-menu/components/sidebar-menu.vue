<template>
  <i-menu
    :theme="currentTheme"
    ref="sideMenu"
    :active-name="currentOpenNames[currentOpenNames.length - 1]"
...
<!--                            <Icon :v-if="child.icon" :type="child.icon" :size="iconSize" :key="child.name+'_icon_sub'"></Icon>-->
            ...
            >
              ...
              <template v-for="childsub in child.children">
                <!-- prettier-ignore -->
                <template v-if="childsub.permission && undefined === childsub.meta.parentName">
...
<script src="./assets/sidebar-menu.js" lang="tsx"></script>
<style lang="less" src="./assets/sidebar-menu.less"></style>
